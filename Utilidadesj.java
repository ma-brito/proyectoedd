...
public class Utilidadesj {
	...
	*/
	public Jugador[] agregarAArregloJugador(Jugador elemento){
	...
	*/
	public Jugador[] leerObjetosArchivo(String ruta_del_archivo){
		...
		do{
			...
			if (objeto != null){
				agregarAArregloJugador((Jugador) objeto);
			}
		}while (objeto != null);
